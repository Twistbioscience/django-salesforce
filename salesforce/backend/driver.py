...
def execute_and_retry_on_idle_connection(url, f, cursor, *args, **kwargs_in):
    try:
        ...
        log.error("Restarting salesforce session because of connection reset by peer error. Method: '{}', url: '{}', args: '{}', kwargs: '{}', headers: {}, params: {}, OAuth: {}".format(f.__func__.__name__, url, args, kwargs_in, cursor.db._sf_session.headers, cursor.db._sf_session.params, cursor.oauth))
